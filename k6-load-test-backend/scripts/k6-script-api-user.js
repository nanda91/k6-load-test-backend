...
export default function() {
  postman[Request]({
    name: "Get List User",
    id: "c7e03ce0-25eb-41a5-bfa4-5ef4ad1d110f",
    method: "GET",
    address: "{{base_url_stg}}/user?page_size=5&page=1",
    headers: {
  ...
  postman[Request]({
    ...
    id: "ce9a8778-a979-4b3e-ba4a-0878b6164628",
    method: "GET",
    address: "{{base_url_stg}}/user/{{user_id}}",
    headers: {
      Authorization: "{{superuser_token}}",
    },
    post(response) {
