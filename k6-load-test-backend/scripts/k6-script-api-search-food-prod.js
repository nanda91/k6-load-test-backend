...
export default function() {
  postman[Request]({
    name: "Get List Food",
    id: "08e9fc25-9b76-4ef6-af06-5ee6e1807828",
    method: "GET",
    address:
      "{{base_url_prod}}/meallogs/foods?page=1&page_size=20&food_name=kopi&max_calorie=5000",
    headers: {
      Authorization: "{{admin_token_prod}}"
    },
    post(response) {
  ...
  postman[Request]({
    ...
    id: "d082891f-0f0e-4fb2-858c-46353b8dedb8",
    method: "GET",
    address:
      "{{base_url_prod}}/meallogs/foods?page=1&page_size=20&max_calorie=5000&is_recipe=true",
    headers: {
      Authorization: "{{admin_token_prod}}"
    },
    post(response) {
      ...
      pm.test("Get food_id from Food Recipe", function() {
        const response = pm.response.json();
        const foodId = response.results[0].id;
        pm.environment.set("food_id", foodId);
      });
  ...
  postman[Request]({
    ...
    id: "5a2b6bfc-d8bd-4586-9484-62ca5f821806",
    method: "GET",
    address:
      "{{base_url_prod}}/meallogs/foods/manual?page=1&page_size=20&max_calorie=5000&food_name=warteg",
    headers: {
      Authorization: "Token hskpat4fqsdgpjyxxtpmdeb2s7shmxu5kdd8pujg"
    },
    post(response) {
      pm.test("Status code is 200", function() {
        pm.response.to.have.status(200);
      ...
      pm.test("Get food_id from food manual", function() {
        const response = pm.response.json();
        const foodId = response.results[0].id;
        pm.environment.set("food_id", foodId);
      });
