...
export default function() {
  postman[Request]({
    ...
    id: "79b08c25-2467-4514-a4a1-be75c8c739a4",
    method: "GET",
    address:
      "{{base_url_stg}}/meallogs/foods?page_size=5&page=1&is_recipe=true",
    headers: {
  ...
  postman[Request]({
    ...
    id: "967c4dc8-07cf-45a3-9c58-c66e9cb64034",
    method: "GET",
    address: "{{base_url_stg}}/meallogs/foods/{{food_id}}/detail",
    headers: {
