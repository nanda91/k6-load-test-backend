...
export default function() {
  postman[Request]({
    name: "Get List Food",
    id: "07c36186-3737-4e8a-8bb6-6c04b591afcf",
    method: "GET",
    address:
      "{{base_url_stg}}/meallogs/foods?page=1&page_size=20&food_name=kopi&max_calorie=5000",
    headers: {
  ...
  postman[Request]({
    ...
    id: "e6fdd031-7d63-4215-9ee7-bb25f78709d1",
    method: "GET",
    address:
      "{{base_url_stg}}/meallogs/foods?page=1&page_size=20&max_calorie=5000&is_recipe=true",
    headers: {
      Authorization: "{{admin_token_prod}}"
    },
    post(response) {
      ...
      pm.test("Get food_id from list food receipe", function() {
        const response = pm.response.json();
        const foodId = response.results[0].id;
        pm.environment.set("food_id", foodId);
      });
  ...
  postman[Request]({
    ...
    id: "a2b4b50d-6b9b-4947-b539-97364ff4d9a5",
    method: "GET",
    address:
      "{{base_url_stg}}/meallogs/foods/manual?page=1&page_size=20&max_calorie=5000&food_name=nasi",
    headers: {
      Authorization: "{{client_token_manual_stg}}"
    },
    post(response) {
      pm.test("Status code is 200", function() {
        pm.response.to.have.status(200);
      ...
      pm.test("Get food_id from list food manual", function() {
        const response = pm.response.json();
        const foodId = response.results[0].id;
        pm.environment.set("food_id", foodId);
      });
